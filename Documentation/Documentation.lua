    ...
    if args.ppwShared then
    	...
    	table.insert( ret3,
    		mbox(
				...
				{ icon = 'PPS_Logo_UI.svg' }
			)
	   )
	   --- Set category
	   table.insert( ret3, '[[Category:' .. string.format( t( 'category_shared_by_the_peak_precision_wikis' ), lang:ucfirst( pageType ) ) .. ']]' )
		--- Interlanguage link
